...
public sealed partial class MainWindow : Window
{
    ...
    private readonly string _windowStatePath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "GoogleTasks", "windowstate.json");
